...
contract EquivalenceProofBN{
    ...
    function getChallenge(eqProofSolR memory prsol, BN254Point memory h2r) public returns (uint256){
        bytes memory b = "";
    ...
    /// @param  prsol is a structure of eqProofSolR type that contains various fields.
    /// @param  h2r is a structure of solpoint type that x and y coordinates.
    function verifyEqProof(eqProofSolR memory prsol, BN254Point memory h2r) public returns (bool){
