...
contract ZKStarkUpdateRangeHashVerifier {
    ...
    // Preprocessed state
    // =========================================================================
    address private immutable _rescueData;
    bytes32 private immutable _rescueDataCodeHash;
    uint256 private _sqrtQ;
    uint32 private _matM;
    uint32 private _matK;
    uint32 private _matD;
    uint32 private _aBlowup;
    uint32 private _aCapHeight;
    ...
    // =========================================================================
    // OOD constraint check (3K+124 CP slots + Aurora identity)
    // =========================================================================
    ...
    // Slots K+1..K+3: balance + recompose m + recompose m_sender
